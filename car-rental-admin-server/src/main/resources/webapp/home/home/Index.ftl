...
<div id="wrap">
            ...
            <div class="w1180">
                ...
                <div class="nav">
                    <ul class="nav-wrap clear_float" id="J_NavBox">
                        <li class="menu-index menu-index-on"><a href="/home/index/index" target="_blank">自驾租车</a><span></span></li>
    ...
    <#if deskUser??>
        <input type="hidden" id="deskUser" value="${deskUser.type}">
    <#else>
        <input type="hidden" id="deskUser" value="-1">
    </#if>
                        ...
                        <li>
                            ...
                            <div class="citystore" id="pickupStore">
                                <input autocomplete="off" class="citysel input-txt"   id="PickupCity" maxlength="10"
                                       ...
                                       value="${userFirst.city}"/>
                                <input autocomplete="off" onclick="storeList()" class="mendian input-txt fl"
                                       id="getStore"
                                       name="PickUpStoreName" type="text" readonly="readonly"
                                       value="${userFirst.shopName}"
                                       data-value="${userFirst.id}" data-address="${userFirst.site}"
                                       data-dd="${userFirst.longitudeAndLatitude}"
                                       data-time="${userFirst.openingHours}" data-phonenumber="${userFirst.mobile}"
                                       data-fromtime="${userFirst.closeOfBusiness}"/>
                            </div>
                        </li>
                        <li>
                            <label class="key">
                            ...
                            <div class="citystore" id="dropoffStore">
                                <input autocomplete="off" class="citysel input-txt" id="ReturnCity" maxlength="10"
                                       ...
                                       value="${userFirst.city}"/>
                                <input autocomplete="off" onclick="retStoreList()" class="mendian input-txt fl"
                                       id="retStore"
                                       name="PickUpStoreName" type="text" readonly="readonly"
                                       value="${retUser.shopName}"
                                       data-value="${retUser.id}" data-address="${retUser.site}"
                                       data-dd="${retUser.longitudeAndLatitude}"
                                       data-time="${retUser.openingHours}" data-phonenumber="${retUser.mobile}"
                                       data-fromtime="${retUser.closeOfBusiness}"/>
                            </div>
                        </li>
                    </ul>
                    <ul class="second">
                        <li>
                            ...
                            <div class="fl" style="display: inline; margin-right: 4px;">
                                <input autocomplete="off" class="layui-input booking-box f-text input-txt"
                        ...
                        <li>
                            ...
                            <div class="fl" style="display: inline; margin-right: 4px;">
                                <input autocomplete="off" class="layui-input booking-box f-text input-txt"
                                       id="returnDate" type="text">
                            </div>
                            <div class="fl" style="display: inline; margin-right: 4px;">
                                <input autocomplete="off" class="layui-input booking-box f-text input-txt"
                                       id="returnTime" type="text">
                            </div>
                        </li>
                    </ul>
                    <input class="reviseBtn" id="buttonSel"/>
                </div>
            </form>
            <div class="prompt-box clearfix">
                <div class="company-prompt"></div>
                <div class="lease-prompt">* 当前选定租期：
                    <span id="leaseDay" data-value=""></span>天
                </div>
            </div>
            <div class="car-box-body">
                <div class="choose-typebox">
                    <div class="choose-model cartypelist">
                        <a class="classify-all">
                            <div class="modelall">
                    ...
                    <div class="choose-branch">
                        <div class="choose-brand choose-ck">
                            ...
                            <#if mobileBrands??>
                                <#list mobileBrands as mobileBrand>
                                    <a href="javascript:;" data-value="${mobileBrand.id}" class=""
                        ...
                        <div class="choose-price choose-ck">
                            ...
                            <div class="pricelist">
                                <a href="javascript:;" class='on'>全部</a>
                                <a data-value="1" href="javascript:;">100元以下</a>
                                <a data-value="2" href="javascript:;">100-200元</a>
                                <a data-value="3" href="javascript:;">200-300元</a>
                                <a data-value="4" href="javascript:;">300元以上</a>
                            </div>
                        </div>
                        <div class="choose-gear choose-ck">
                            ...
                            <#if mobileStallsEnums??>
                                <#list mobileStallsEnums as mobileStalls>
                                    <a href="javascript:;"
                                       data-value="${mobileStalls.getCode()}">${mobileStalls.getName()}</a>
                                </#list>
                            </#if>
                            </div>
                        </div>
                        <div class="choose-seat choose-ck">
                            ...
                            <#if mobileSeatEnums??>
                                <#list mobileSeatEnums as mobileSeat>
                                    <a href="javascript:;"
                                       data-value="${mobileSeat.getCode()}">${mobileSeat.getName()}</a>
                                </#list>
                            </#if>
                            </div>
                        </div>
                ...
                <div class="sort clearfix">
                    <ul class="field-orderby" sortby="null">
                        <li class="sort-default">
                            <a href="javascript:;" id="sortDefault" onclick="defaultSort()" class="order-def">
                                默认排序
                            </a>
                        </li>
                        <li class="sort-price" id="sortPrice" data-value="0" onclick="rentSort(this)">
                            <a href="javascript:;" class="order-def">
                                按租金<span class="sort-icon"></span>
                            </a>
                        </li>
                        <li class="sort-emission" id="sortEmission" data-value="0" onclick="emissionSort(this)">
                            <a href="javascript:;" class="order-def" value="OutputVolume">
                                按排量
                    ...
                    <div class="field-tip">
                        共有
                        <span id="carTypeCount">${releaseVehicleInformationSize}</span>
                        种车型可以租用
                    </div>
                </div>
                                ...
                                <div class="det-carlist">
                                    <ul>
                                        <li class="licar-picbox">
                                            <input type="hidden" id="releInfoId"
                                                   value="${releaseVehicleInformation.id}"/>
                                        ...
                                        <li class="licar-namebox">
                                            <div class="licar-nameinfo">
                                                ...
                                                <p class="car-introinfo">
                                                    ...
                                                    |
                                                    <a onclick="viewCarVideo(this)" href="javascript:void(0)"
                                        ...
                                        <li class="licar-info">
                                            <p class="condition1">
                                                ...
                                                <span class="typebtn btntop1 "
                                                      data-value="${releaseVehicleInformation.id}"
                                                      onclick="booking(this)" onmouseout="deDet(this)">
        ...
        <div class="step1-body-right">
            <div id="divBookingInfo">
                ...
                <div class="step1-storeinfo">
                    <ul>
                        <li>取车门店：</li>
                        <li><span id="setStore">${userFirst.shopName}</span></li>
                        <li><span id="setSite">${userFirst.site}</span></li>
                        <li><em>门店电话：</em><em><span id="setPhone">${userFirst.mobile}</span></em></li>
                        <li><em>营业时间：</em><em><span id="setBusinessHoursStart">${userFirst.openingHours}</span>-<span
                                id="setBusinessHoursEnd">${userFirst.closeOfBusiness}</span></em></li>
                    </ul>
                </div>
            </div>
        </div>
    </div>
    <div id="carStoreBox"></div>
                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper" style="width: 780px; height: 425px;">
                        <div class="swiper-slide swiper-no-swiping swiper-slide-visible swiper-slide-active"
                            ...
                            <video id="carVideo0" controls="controls"></video>
                            <p id="brand"></p>
                        </div>
                    </div>
                </div>
    ...
    <div id="ydkBox" class="ydk-box" style="left: 537.5px; top: 216px; position: absolute; display: none;">

    </div>
    <!--门店营业时间-->
    <ul id="timeselect" class="timeselect">
...
<!-- 遮罩层 -->
<div id="cover"
     style="background: #000; position: absolute; left: 0px; top: 0px; width: 100%; filter: alpha(opacity=30); opacity: 0.7; display: none; z-index: 2 ">
    ...
    <ul class="tabHF-content list-city">
        <li class="current">
            <div class="inner-box">
                <dl>
                    <dd>
                        <span class="selected" sendcar="Y" rel="上海" pre="SH  " dsi="886" data-id="77">上海</span>
                    </dd>
                    <dd>
    ...
    <div class="popup-left">
        ...
        <div class="popup-left-content">
            <div class="popup-left-top">
                <span></span><em></em>注册<em></em><span></span>
            </div>
    ...
    <div class="popup-right">
        ...
        <div class="popup-registerinfo hide">
            ...
            <div class="popup-register">
                ...
                <p class="popup-error-msg"></p>
                <p class="popup-operate-btn" style="margin-top: 50px">
...
<script type="text/javascript" src="/home/js/70e6fb39df414dba8fae67b93b950ba8.js"></script>
...
<script>
    ...
    // 加载伪分页
    function pagesizeLoad() {
        var num = $(".myshowbox .pagesize-list > li").length,
                _height = $(".myshowbox .pagesize-list > li").height();
        //数据少于n条不显示分页
        if (num > 2 && _height === 131) {
            totalPages = num % 2 == 0 ? parseInt(num / 2) : parseInt(num / 2) + 1;
        } else if (num > 4 && _height === 65) {
            totalPages = num % 4 == 0 ? parseInt(num / 4) : parseInt(num / 4) + 1;
        } else {
            $(".page-box").hide();
        }
        createPageBtn(totalPages, curIndex)
    };

    // 创建伪分页
    function createPageBtn(totalPages, curIndex) {
        var tempStr = "";
        if (curIndex > 1) {
            tempStr += "<a class='page-btn page-prev' data-page = " + (curIndex - 1) + ">上一页</a>"
        }
        if (totalPages <= 5) {
            for (var pageIndex = 1; pageIndex < totalPages + 1; pageIndex++) {
                tempStr += "<a class='page-btn page" + pageIndex + "' data-page=" + (pageIndex) + "><span>" + pageIndex + "</span></a>";
            }
        } else {
            if (curIndex < 4) {
                ...
                tempStr += '<span>......</span>';
                tempStr += "<a class='page-btn page" + pageIndex + "' data-page=" + (totalPages) + "><span>" + totalPages + "</span></a>";
            } else if (curIndex > totalPages - 3) {
                tempStr += "<a class='page-btn page" + 1 + "' data-page=" + (1) + "><span>" + 1 + "</span></a>";
                tempStr += '<span>......</span>';
                for (var pageIndex = totalPages - 3; pageIndex <= totalPages; pageIndex++) {
                    tempStr += "<a class='page-btn page" + pageIndex + "' data-page=" + (pageIndex) + "><span>" + pageIndex + "</span></a>";
                }
            } else if (curIndex >= 4 && curIndex <= totalPages - 3) {
                tempStr += "<a class='page-btn page" + 1 + "' data-page=" + (1) + "><span>" + 1 + "</span></a>";
                tempStr += '<span>......</span>';
                for (var pageIndex = curIndex - 2; pageIndex <= curIndex + 2; pageIndex++) {
                    tempStr += "<a class='page-btn page" + pageIndex + "' data-page=" + (pageIndex) + "><span>" + pageIndex + "</span></a>";
                }
                tempStr += '<span>......</span>';
                tempStr += "<a class='page-btn page" + pageIndex + "' data-page=" + (totalPages) + "><span>" + totalPages + "</span></a>";
        ...
        if (curIndex < totalPages) {
            tempStr += "<a class='page-btn page-next' data-page = " + (curIndex + 1) + ">下一页</a>";
        }

        $(".myshowbox .page-content").html(tempStr);
        $('.page' + curIndex).css({'background': '#fff', 'color': '#333'});
    }

    // 伪分页页码切换
    $(".myshowbox .page-btn").live('click', function () {
        var _height = 264;
        var curIndex = $(this).data('page');
        $(".div-myshowbox .pagesize-list").css("top", -_height * (curIndex - 1) + "px");
        createPageBtn(totalPages, curIndex)
    });
...
<script type="text/javascript">
    ...
    $("#PickupCity").blur(function () {
        $("#getStore").attr("data-value","-1");
        $("#retStore").attr("data-value","-1");
        $("#getStore").attr("value","");
        $("#retStore").attr("value","");
    });
    ...
    function loadMordBox() {
        var id = $("#getStore").attr("data-value");
    ...
    //换门店查看车辆信息
    function changingStores(t) {
        var introduceName = $(t).attr("data-name");
        var userId = $("#getStore").attr("data-value");
        ...
        $.ajax({
            type: 'post',
            data: jsonString,
            url: '/home/index/carStore',
            contentType: 'application/json;charset=utf-8', //设置请求头信息,防止乱码
            dataType: 'html',
            async: true,
            success: function (data) {
                $("#carStoreBox").after(data);
                pagesizeLoad();
                $("#showCarStoreBox").css("display", "");
    ...
    var dataDd = $("#getStore").attr("data-dd");
    ...
    script.type = 'text/javascript';
    script.src = '//api.map.baidu.com/api?v=2.0&ak=4cA06UwGGogWDrWkvZ4nhAj1bD&callback=init';
    document.body.appendChild(script);

    // 百度地图API功能
    var map = new BMap.Map("allmap"); // 创建Map实例
    var point = new BMap.Point(dd_1, dd_2);
    ...
    function viewDet(t) {
        $(t).next().attr('class', 'typebtn btntop1 typedis');
        $(t).next().css('display', 'block');

    }

    function deDet(t) {
        $(t).attr('class', 'typebtn btntop1');
        $(t).css('display', 'none');
    }

    //默认排序
    function defaultSort() {
        $("#sortPrice").children().first().attr("class", "order-def");
        $("#sortPrice").attr("data-value", "0");
        $("#sortEmission").children().first().attr("class", "order-def");
        $("#sortEmission").attr("data-value", "0");
        $("#sortDefault").attr("class", "order-def");
        select();
    }

    //按租金排序
    function rentSort(t) {
        $("#sortDefault").attr("class", "");
        $("#sortEmission").attr("data-value", "0");
        $("#sortEmission").children().first().attr("class", "order-def");
        var sortNum = $(t).attr("data-value");
        if (sortNum == 2 || sortNum == 0) {
            $(t).children().first().attr("class", "order-asc");
            $(t).attr("data-value", "1");
        }
        if (sortNum == 1) {
            $(t).children().first().attr("class", "order-desc");
            $(t).attr("data-value", "2");
        }
        select();
    }
    ...
    function storeList() {
        ...
        $.ajax({
            ...
            success: function (data) {
                $("#ydkBox").html(data);
                $("#ydkBox").attr("data-type","0");
            }
        });

    }
    //根据还车门店查询
    function retStoreList() {
        var pickupCity = $("#ReturnCity").val();
        $.ajax({
            type: 'POST',
            url: '/home/index/storeList',
            contentType: 'application/json;charset=utf-8', //设置请求头信息,防止乱码
            ...
            success: function (data) {
                $("#ydkBox").html(data);
                $("#ydkBox").attr("data-type","1");
            }
        });
    }

    function wrapContent(that) {
        var district = $(that).attr("date-value");
        $.ajax({
            type: 'POST',
            url: '/home/index/wrapContent',
            contentType: 'application/json;charset=utf-8', //设置请求头信息,防止乱码
            data: district,
            dataType: 'html',
            async: true,
    ...
    function butSel() {
        ...
        var pickUpStr = pickUpDate.toString() + " " + pickUpTime.toString();
        var reDateStr = returnDate.toString() + " " + returnTime.toString();
        var nowDate = new Date();
        var pickUp = new Date(pickUpStr);
        var reDate = new Date(reDateStr);
        if (pickUp.getTime() < nowDate.getTime()) {
            alert("取车时间不能小于当前时间！");
            return false;
        }
        if (reDate.getTime() < nowDate.getTime()) {
            alert("还车时间不能小于当前时间！");
            return false;
        }
        if (pickUp.getTime() > reDate.getTime()) {
            alert("取车时间不能大于还车时间！");
            return false;
        }

        var drr = Math.abs(reDate.getTime() - pickUp.getTime());
        var day = parseInt(drr / (24 * 60 * 60 * 1000));
        var hours = parseInt(drr % (24 * 60 * 60 * 1000) / (60 * 60 * 1000));
        if (parseInt(drr / (60 * 60 * 1000)) < 4) {
            alert("租车时间不能小于四个小时！");
            return false;
        }
        if (hours < 7 && hours != 0) {
    ...
    $(".brandlist").on('click', 'a', function () {
        ...
        var brand = $SelectedBrand.data("value");
        carType.isLoading = false;
        if (!brand) {
            //清空选择
            Filter.clearBrands();
            $SelectedBrand.addClass("on").siblings().removeClass("on");
            select();
            return;
        }
        if ($SelectedBrand.hasClass("on")) {
            //删除一个选择项
            Filter.removeBrand(brand);
            $SelectedBrand.removeClass("on");
        } else {
            //添加一个选择项
            Filter.addBrands(brand);
            $SelectedBrand.addClass("on");
        }
        if (Filter.selectBrands.length > 0) {
            //选中一个以上，去掉“全部”选中状态
            $(".brandlist a:first").removeClass("on");
        } else {
            //逐个取消选中后，默认选中“全部”状态
            $(".brandlist a:first").addClass("on");
        }
        select();
    });
    ...
    function buttonSel() {
       ...
       if(id == -1){
        ...
        $.ajax({
            type: 'POST',
            url: '/home/index/geographicalMap',
            data: {
                id: id
            },
            dataType: 'html',
    ...
    //筛选查询
    function select() {
        var getStore = $("#getStore").attr('data-value');    //取车门店id
        var retStore = $("#retStore").attr('data-value');   //还车门店id
        if (getStore == -1){
            alert("请选择取车门店");
            return;
        }
        ...
        var brandlistIds = $(".brandlist").find("a.on").each(function () {     //遍历高亮品牌对象
            brandlist.push($(this).attr("data-value"))       //将其高亮的标签中的data-value值添加至brandlist数组中
        });
        var gearlist = $(".gearlist").find("a.on").attr("data-value");
        var seatlist = $(".seatlist").find("a.on").attr("data-value");
        var cartypelist = $(".cartypelist").find("a.on").attr("data-value");
        var pricelist = $(".pricelist").find("a.on").attr("data-value");
        var rentSort = $("#sortPrice").attr("data-value"); //价格排序
        var emissionSort = $("#sortEmission").attr("data-value"); //排量排序
        let id = userId;
        if (id == undefined){
            id = $("#getStore").attr("data-value");
        }
        var dataJson = JSON.stringify({
            brandList: brandlist,
            automobileStalls: gearlist,
            automobileSeat: seatlist,
            automobileType: cartypelist,
            dailyRentalRate: pricelist,
            userId: id,
            rentSort: rentSort,
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                let getStore = $('#getStore').val();
                let dataAddress = $("#getStore").attr("data-address");
                let dataTime = $("#getStore").attr("data-time");
                let dataPhoneNumber = $("#getStore").attr("data-phoneNumber");
                let dataFromTime = $("#getStore").attr("data-fromTime");
                let dataDd = $("#getStore").attr("data-dd");
                let dataDdArr = dataDd.split(",");
                dd_1 = Number(dataDdArr[0]);
                dd_2 = Number(dataDdArr[1]);
                $('#setStore').text(getStore);
                $('#setSite').text(dataAddress);
                $('#setPhone').text(dataPhoneNumber);
                $('#setBusinessHoursStart').text(dataFromTime);
                $('#setBusinessHoursEnd').text(dataTime);
                carCount();
    ...
    //统计共有多少个车
    function carCount() {
        var carCount = $(".det-carlist").length;
        $("#carTypeCount").html(carCount);
    }

    //预订
    function booking(t) {
        var userType = $("#deskUser").val();
        if (userType == -1) {
            linkLogin();
            return false;
        }
        var releInfoId = $(t).attr("data-value");
        if (releInfoId == "" || releInfoId == undefined) {
            return false;
        }
        butSel();
        var getStore = $("#getStore").attr('data-value');    //取车门店id
        ...
        var lease = $("#leaseDay").attr("data-value");      //租期id
        var pickUpStr = $("#pickUpDate").val().toString() + " " + $("#pickUpTime").val().toString();
        var reDateStr = $("#returnDate").val().toString() + " " + $("#returnTime").val().toString();
        if (getStore == -1) {
            alert("请选择取车门店");
            return false;
        }
        ...
        window.location.href = "/home/index/advanceOrder?" + "releInfoId=" + releInfoId +
                "&lease=" + lease + "&getStore=" + getStore + "&retStore=" + retStore +
                "&pickUpStr=" + pickUpStr + "&reDateStr=" + reDateStr
    ...
    function storeValue(storeObj) {
        ...
        var type = $("#ydkBox").attr("data-type");

        if (type == 0){
            $("#getStore").attr("data-value", sid);
            $("#retStore").attr("data-value", sid);
            $("#getStore").attr("data-address", address);
            $("#getStore").attr("data-time", time);
            $("#getStore").attr("data-phoneNumber", phoneNumber);
            $("#getStore").attr("data-fromTime", fromTime);
            $("#getStore").attr("data-dd", dd);
        }
        if (type == 1){
            $("#retStore").attr("data-value", sid);
        }
    ...
    function viewCarVideo(t) {
        var id = $(t).attr("data-cartypeids");
        $.ajax({
            type: 'post',
    ...
    //关闭换门店视频
    function closeCarStore() {
        $("#showCarStoreBox").remove();
...
<script>
    $(document).ready(function () {
        ...
        if (user != null & user != "") {
            ...
            $("#spanLogined").addClass("hide");
            $("#spanLogin").removeClass("hide");
            linkLogin();
        }
        //初始化验证码
