...
<title>${siteName!""}|汽车分类管理-${title!""}</title>
              ...
              <div class="card-toolbar clearfix">
                <form class="pull-right search-bar" method="get" action="list" role="form">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" value="${brand!""}" name="brand" placeholder="请输入汽车品牌">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <#list pageBean.content as category>
                      <tr>
                        ...
                        <td style="vertical-align:middle;" style="vertical-align:middle;"><font class="text-success">${category.createTime?string("yyyy-MM-dd")}</font></td>
                      </tr>
                    </#list>
                    <#else>
...
function deleteReq(id,url){
	$.ajax({
		...
		success:function(data){
			if(data.code == 0){
				showSuccessMsg('汽车品牌删除成功!',function(){
